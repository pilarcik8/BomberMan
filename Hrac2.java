...
/**
 * Te to kópia tridy Hrac1
 * Jediná zmena je premenované metódy pohyb* a aktivujBombu
...
public class Hrac2 {    
    ...
    /**
     * Posunie hráča o 1 krok dole, po pustení (released) tlačidla S
    ...
    /**
     * Posunie hráča o 1 krok hore, po pustení (released) tlačidla W
     * Pošle správu s menom obrázka metóde animácia (bez číslice a .png)
     * Podmienka: !this.pohybVodorovne zabranuje charakteru ísť šikmo
    ...
    /**
     * Posunie hráča o 1 krok vpravo, po pustení (released) tlačidla D
     * Pošle správu s menom obrázka metóde animácia (bez číslice a .png)
    ...
    /**
     * Posunie hráča o 1 krok vlavo, po pustení (released) tlačidla A
     * Pošle správu s menom obrázka metóde animácia (bez číslice a .png)
     * Podmienka: !this.pohybHorizontalne zabranuje charakteru ísť šikmo
    ...
    /**
     * Položí bombu 1, 2 alebo 3 pod nohy hráča po pustení (released) tlačidla SPACE
